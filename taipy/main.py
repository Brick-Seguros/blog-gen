...
conversation = {
    "Conversation": ["Oi, tudo bem?", "Oi, eu sou o gerador de textos de blog da Brick, como eu posso te ajudar hoje?"]
}
...
def request(state: State, prompt: str) -> str:
    ...
    return """
        ...
        Clique na url abaixo para baixar o texto completo:
...
## **Brick**{: .color-primary} Blog Gen ## {: .logo-text}
<|Nova Conversa|button|class_name=fullwidth plain|id=reset_app_button|on_action=reset_chat|>
### Conversas anteriores ### {: .h5 .mt2 .mb-half}
...
<|{current_user_message}|input|label=Escreva sua mensagem aqui...|on_action=send_message|class_name=fullwidth|change_delay=-1|>
|>
|>
|>
"""
...
if __name__ == "__main__":
    Gui(page).run(debug=True, dark_mode=True, use_reloader=True, title="💬 Brick Blog Gen", port=8181)